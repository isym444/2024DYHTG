...
var genergy = global.energy

# Size of the graph
var graph_width: int = 300
var graph_height: int = 159

# Predefined Y-axis values for the graph (can be dynamically updated)
var y_values: Array = [genergy]  # Example with a variety of values
...
var origin_offset: Vector2 = Vector2(50, graph_height / 2)  # Centered on the Y-axis
...
func _draw():
	...
	var origin = Vector2(50, graph_height / 2)  # X = 50 for padding, Y is aligned to the middle of the graph
